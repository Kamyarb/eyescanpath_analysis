...
function table = read_table(trial_num)
    if trial_num <40
        table = readtable('./new_subject/Results_csv/sub101.csv');
    elseif trial_num > 40 && trial_num <= 80
        table = readtable('./new_subject/Results_csv/sub102.csv');
         
    elseif trial_num > 80 && trial_num <= 120
        table = readtable('./new_subject/Results_csv/sub103.csv');
    else
        table = readtable('./new_subject/Results_csv/sub104.csv');
    end
end
...
function edf = read_edf(trial_num)
    if trial_num <40
        edf = Edf2Mat('./new_subject/Code/edf+files/pilot/sub101.edf');
    elseif trial_num > 40 && trial_num <= 80
        edf = Edf2Mat('./new_subject/Code/edf+files/pilot/sub102.edf');
         
    elseif trial_num > 80 && trial_num <= 120
        edf = Edf2Mat('./new_subject/Code/edf+files/pilot/sub103.edf');
    else
        edf = Edf2Mat('./new_subject/Code/edf+files/pilot/sub104.edf');
    end
end
